...
ifstream leerArchivo(const string &nombreArchivo, const string &threshold, const string &nivel_de_determinismo)
{
    ...
    th = stof(threshold) * M;
    alpha = stof(nivel_de_determinismo) * 100;
...
int main(int argc, const char *argv[])
{
    ...
    if (argc == 5)
    {
        archivo = leerArchivo(argv[2], argv[4], argv[6]);
    }
    else
    {
        archivo = leerArchivo("100-300-001.txt", "0.85", "0.9");
    }
